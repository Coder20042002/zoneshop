                                ...
                                <ul class="header_navbar--main-list">
                                    ...
                                    <li class="header_navbar--main-list-item ">
                                        <a href="./category"
                                            ...
                                            class="header_navbar--main-list-item-link header_navbar--main-list-item--separate">
                                            SẢN PHẨM
                                    ...
                                    <li class="header_navbar--main-list-item">
                                        <a href="#"
                                            class="header_navbar--main-list-item-link header_navbar--main-list-item--separate">SALE</a>
                                    </li>
