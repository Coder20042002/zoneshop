...
class CartModel extends DB
{
    ...
    function  suggestProducts1() {
        $truyvan="SELECT * FROM `tbl_sanpham` WHERE attribute ='sale' ORDER BY gia ASC LIMIT 1";
        return mysqli_query($this->con,$truyvan);
    }
    function  suggestProducts2() {
        $truyvan="SELECT * FROM `tbl_sanpham` WHERE attribute ='sale' ORDER BY gia ASC LIMIT 2,1";
        return mysqli_query($this->con,$truyvan);
    }
    function  suggestProducts3() {
        $truyvan="SELECT * FROM `tbl_sanpham` WHERE attribute ='sale' ORDER BY gia ASC LIMIT 3,1";
        return mysqli_query($this->con,$truyvan);
    }
    function  suggestProducts4() {
        $truyvan="SELECT * FROM `tbl_sanpham` WHERE attribute ='sale' ORDER BY gia ASC LIMIT 4,1";
        return mysqli_query($this->con,$truyvan);
    }
}
